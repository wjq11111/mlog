...
function mouseScroll(obj)
{
	...
	for(var i=0; i<aLi.length; i++)
	{
		...
		oA.href='http://hebca.com/tgcj/tgtuandui.html';
		oA.target='_blank';
		oA.innerHTML=i+1;
		oP.appendChild(oA);
	}
	...
	function picScroll()
	{
		...
		var maindiv = document.getElementById("bg_img");
		var context = getWebRootPath();
		//maindiv.style.backgroundImage = "url("+context+"/_static/images/front/indexbg"+(iCurr+1)+"_12.jpg)";
		maindiv.src = context+"/_static/images/front/indexbg"+(iCurr+1)+"_12.jpg";
		var tmpArr=[];
