								...
								<td valign="top" width="99%">
									<table width="600px" align="left" border="0" cellspacing="3" cellpadding="0">
										<tr>
											<td height="40px">
												<br>						
<p>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px;line-height:16px;width:15px" class="icon1">&nbsp;&nbsp;</span><span style="font-size:16px">&nbsp; 错误提示</span></p>
<hr style="border:1px dotted #39f;margin-top: -3px;" size="0px">
<dir class="condiv">
	<B class="icoIfo2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</B><span id="firstReadCon">详细信息为：</span>
	<br>
	<br>
	<pre>
			...
			<c:choose>
			      <c:when test="${not empty url}">
			         <a style="padding-left:35px;font-weight: 600;"
						href='<c:out value="${url}"/>&<c:out value="${parameter}"/>'>
						<font color='#444444'>返回上一步</font></a>
			      </c:when>
			      <c:otherwise>
			          <a style="padding-left:35px;font-weight: 600;"
